...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { comment: @opinion.comment, date: @opinion.date, mark: @opinion.mark, pseudo: @opinion.pseudo }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { comment: @opinion.comment, date: @opinion.date, mark: @opinion.mark, pseudo: @opinion.pseudo }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
